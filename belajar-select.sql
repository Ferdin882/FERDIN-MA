...
14. SELECT * FROM siswa
      WHERE nilai BETWEEN "80" AND "90" ORDER BY nilai ASC;
    SELECT * FROM siswa
      WHERE nilai BETWEEN "80" AND "90" ORDER BY nilai DESC;
15. DELETE FROM siswa 
      WHERE nis = "12002406";
16. SELECT tempatlahir
      FROM siswa GROUP BY tempatlahir;
17. SELECT nama,kelas,nilai
      FROM siswa;
18. SELECT * FROM siswa
      WHERE tempatlahir != "subang"
19. SELECT * FROM siswa
      WHERE nilai >="80" AND <="90";
